        ...
        <footer className="footer">
            ...
            <div className="footer__section footer__section--second">
                <div className="footer__container">
                    <p>
                        <strong>
                        Projeto Elaborado durante a RDW <a href="https://ebaconline.com"
                        target="_blank">E.B.A.C</a> 2021</strong>
                        <small>
                            Projetado por <a href="https://github.com/fabiocamposeagle/acessoBR.git" target="_blank"> Fábio Campos</a>
                        </small>
                    </p>
